        ...
        <div className='max-w-4xl m-auto'>
            ...
            <div className="create_flex">
                <div className='w-2/4 flex flex-col gap-3'>
                    ...
                    <textarea  className='rounded-md w-96 h-20 pl-3 pt-2 border-1 max-3ssm:w-80 max-3sssm:w-72' id='description'  placeholder='Description' onChange={handlechange} value={formdata.description}>
                    </textarea>
                    <input className='w-96 h-12 px-3 rounded-md mb-3 border-1 max-3ssm:w-80 max-3sssm:w-72' id='address' type='text' placeholder='Address' onChange={handlechange} value={formdata.address}/>
                    ...
                    <span className=''>Parking</span><span>Spot</span>
                        </span>
                ...
                <div className='w-2/4 flex flex-col gap-3'>
                    ...
                    <div className='flex  gap-2 items-center'>
                        {
                            error?  <span><input type='file' multiple className=' h-12 border-[1px] border-gray-300 w-96  p-2 rounded-md max-3ssm:w-80 max-3sssm:w-72' disabled onChange={uploadfile} id='imgurls'/></span>
                                :
                                <span><input type='file' multiple className=' h-12 border-[1px] border-gray-300 w-96  p-2 rounded-md max-3ssm:w-80 max-3sssm:w-72' onChange={uploadfile} id='imgurls'/></span>
